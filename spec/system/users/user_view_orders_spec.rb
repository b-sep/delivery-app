...
describe 'Usuário visualiza ordens de serviço' do
  it 'com sucesso' do
    ...
    o2 = Order.create!(heigth: 20, depth: 30, width: 20, distance: 300, weight: 11, price: 22, days: 4, user: 'Júnior', address: 'qs 19', hauler: hauler, status: 'accepted')
    ...
    expect(page).to have_content "Ordem: #{o2.code} | status: Aceita"
  end
